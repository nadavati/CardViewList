...
public class SingleActivity extends FragmentActivity implements
    ...
    private void handleNewLocation(Location location) {
        ...
        MarkerOptions options1 = new MarkerOptions().position(latLng1).title("Not Furnished | 2 BHK | Rs 15000/pm | Family");
        ...
        MarkerOptions options3 = new MarkerOptions().position(latLng3).title("Not Furnished | 1 BHK | Rs 8000/pm | Family");
